...
def run_sp_example():
    ...
    params = {
        'N': 10, 'c': 4, 'nIndi': 3, 'indiJitter': 0.01,
    ...
    #spikes = load_spikes_from_mat('Dataset_Fig6.mat')
