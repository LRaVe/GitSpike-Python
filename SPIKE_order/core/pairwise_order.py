"""Compute pairwise spike-order contributions between two spike trains."""

import numpy as np
from spike_common import coincidence_window


def pairwise_order(tmin, tmax, spikes, spike_ind1, spike_ind2):
    n = len(spikes)
    ...
    res = np.zeros(len(s1), dtype=float)
